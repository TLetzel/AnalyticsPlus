...
@SpringView(name = Lvl3NavigationView.VIEW_NAME)
@UIScope
public class Lvl3NavigationView extends CssLayout implements View {

	private static final long serialVersionUID = 1L;

	public static final String VIEW_NAME = "lvl3 navigation";
	...
	private void initLeftLayout() {
		...
		Button hplcButton = createNavButton("HPLC Exam");
		hplcButton.addClickListener(e -> navigateTo(ExamView.VIEW_NAME));
	...
	private void initRightLayout() {
		...
		Button examButton = createNavButton("Sample preparation Exam");
		examButton.addClickListener(e -> navigateTo(SamplePrepExamView.VIEW_NAME));
		rightLayout.addComponent(examButton);
