...
@SpringView(name = ExamView.VIEW_NAME)
@UIScope
public class ExamView extends CssLayout implements View {

	private static final long serialVersionUID = 295647889946997930L;

	public static final String VIEW_NAME = "exam";
	...
	@Autowired
	private ElutionComponent elutionComponent;
	...
	private void initDataLayout() {
		...
		initStyle(elutionComponent);
		dataLayout.addComponent(elutionComponent);
